...
<head>
    ...
    <link rel="stylesheet" href="../estilos/estilosfondos/fondoalmacen.css">
...
<body>
   ...
   <form action="../mysql/insertar.php" method="post" class="registrar-mode" >
    ...
    <form action="../cambiosPaginas/cam_almacen.php" method="post" class="actualizar-mode">
       
       <div class="formulario">
           <h2>ACTUALIZAR ALMACENES</h2>
