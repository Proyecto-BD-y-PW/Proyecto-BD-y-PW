...
<head>
    ...
    <title>Pieza Armado</title>
    <link href="https://fonts.googleapis.com/css2?family=Lato:wght@300;400;700;900&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="../estilos/normalize.css">
    <link rel="stylesheet" href="../estilos/home.css">
    <link rel="stylesheet" href="../estilos/estilosfondos/fondopiezaarmado.css">
...
<body>
   ...
   <form action="../mysql/insertar.php" method="post" class="registrar-mode" >
          <div class="formulario" >
           <h2>REGISTRAR PIEZAS DE ARMADO</h2>
    ...
    <form action="../mysql/eliminar.php" method="post" class="eliminar-mode">
       <div class="formulario">
            <h2>ELIMINAR PIEZAS DE ARMADO</h2>
            ...
            <select name="id-elim" id="elim-id" class="remove" required <?php echo $acceso_elim ;?>>
                ...
                <option value="" selected disabled>Piezas de armado disponibles</option>
                 <?php 
                    $op="SELECT pa.id,p.nombre,p.modelo FROM pieza_armado pa JOIN pieza p ON pa.id=p.id";
                    $conexion=mysqli_connect("localhost",$usuario,$pass,"inventarios");
                    $resultado=mysqli_query($conexion,$op);
    ...
    <form action="enviar.php" method="post" class="actualizar-mode">
       ...
       <div class="formulario">
           <h2>ACTUALIZAR PIEZAS DE ARMADO</h2>
 ...
 <form action="../consultas/pieza_armado.php" method="post" class="consultar-mode">
       
       <div class="formulario">
           <h2>CONSULTAR PIEZAS DE ARMADO</h2>
            ...
            <select name="tipo-cons" id="consultas" class="entrada" required <?php echo $acceso_cons ;?>>
              ...
              <select name="id-cons" id="consultas-id" class="remove" required <?php echo $acceso_cons ;?>>
                ...
                <option value="" selected disabled>Piezas de armado disponibles</option>
                 <?php 
                    $op="SELECT *,pa.id,p.id 'id_pieza' FROM pieza_armado pa JOIN pieza p ON pa.id=p.id";
                    $conexion=mysqli_connect("localhost",$usuario,$pass,"inventarios");
                    $resultado=mysqli_query($conexion,$op);
